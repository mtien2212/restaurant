<html>
    ...
    <body>
        ...
        <div class="btn"><a href="/admin/antainha"><button class="btn btn-secondary" id="tl">Trở lại</button></a><button class="btn btn-primary" onClick="xoa()" id="inhd">In hóa đơn</button></div>
    </body>
    <script>
      ...
      function xoa(){
        ...
        window.print();
        window.location = "/admin/hoadon?id={{ $id }}";
      }
    </script>
