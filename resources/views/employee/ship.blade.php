        ...
        <table class="table table-bordered">
          ...
          <tbody>
            ...
            <tr>
                ...
                <td>
                  <!-- Button them moi -->
                  <a href="/nhanvien/hoadon?id={{ $item->madonhang }}"><button type="button" class="btn btn-success"><i class="bi bi-printer"></i></button></a>
                  <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#id{{ $item->madonhang }}"><i class="bi bi-eye"></i></button>
                  <!-- Them moi -->
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <a href="/nhanvien/hoanthanh?id={{ $item->madonhang }}"><button type="button" class="btn btn-success">Hoàn thành</button></a>
