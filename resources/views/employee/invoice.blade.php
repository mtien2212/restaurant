<html>
    ...
    <body>
        ...
        <div class="btn"><a href="/nhanvien/order"><button class="btn btn-secondary" id="tl">Trở lại</button></a><button class="btn btn-primary" onClick="xoa()" id="inhd">In hóa đơn</button></div>
    </body>
    <script>
